...
export const btcConfig: PairConfig = {
  ...
  positionSizing: {
    ...
    hfPositionSize: parseFloat(process.env.BTC_HF_POSITION_SIZE || process.env.HF_POSITION_SIZE || '0.15'),
    maxPositionSize: parseFloat(process.env.MAX_POSITION_SIZE || '0.25'),
  },
  
  // Leverage settings (pair-specific overrides global defaults)
  leverageSettings: {
    anchorLeverage: parseInt(process.env.BTC_ANCHOR_LEVERAGE || process.env.ANCHOR_LEVERAGE || '20'),
    hedgeLeverage: parseInt(process.env.BTC_HEDGE_LEVERAGE || process.env.HEDGE_LEVERAGE || '25'),
    opportunityLeverage: parseInt(process.env.BTC_OPPORTUNITY_LEVERAGE || process.env.OPPORTUNITY_LEVERAGE || '20'),
    scalpLeverage: parseInt(process.env.BTC_SCALP_LEVERAGE || process.env.SCALP_LEVERAGE || '15'),
    scalpHedgeLeverage: parseInt(process.env.BTC_SCALP_HEDGE_LEVERAGE || process.env.SCALP_HEDGE_LEVERAGE || '25'),

...
export const ethConfig: PairConfig = {
  ...
  leverageSettings: {
    anchorLeverage: parseInt(process.env.ETH_ANCHOR_LEVERAGE || process.env.ANCHOR_LEVERAGE || '10'),
    hedgeLeverage: parseInt(process.env.ETH_HEDGE_LEVERAGE || process.env.HEDGE_LEVERAGE || '15'),
    opportunityLeverage: parseInt(process.env.ETH_OPPORTUNITY_LEVERAGE || process.env.OPPORTUNITY_LEVERAGE || '10'),
    scalpLeverage: parseInt(process.env.ETH_SCALP_LEVERAGE || process.env.SCALP_LEVERAGE || '15'),
    scalpHedgeLeverage: parseInt(process.env.ETH_SCALP_HEDGE_LEVERAGE || process.env.SCALP_HEDGE_LEVERAGE || '15'),
